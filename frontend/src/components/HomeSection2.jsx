      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 max-w-6x mx-auto py-5">
          ...
          <Link to="/about">
            <div
              data-aos="fade-up"
              className="bg-white/10 flex-col backdrop-blur-md p-6 border-cyan-400 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300 flex items-center justify-center border-[.1em] hover:border-black hover:text-black hover:bg-blue-100 h-[13em]"
            >
          ...
          <Link to="/about">
            <div
              data-aos="fade-down"
              className="bg-white/10 flex-col backdrop-blur-md p-6 rounded-xl shadow-lg border-cyan-400 transform hover:scale-105 transition-transform duration-300 flex items-center justify-center h-[13em] border-[.1em] hover:border-black hover:bg-white hover:text-black
            "
            >
          ...
          <Link to="/about">
            <div
              data-aos="fade-up"
              className="bg-white/10 backdrop-blur-md p-6 flex-col rounded-xl border-cyan-400 shadow-lg transform hover:scale-105 transition-transform duration-300 flex items-center justify-center border-[.1em] h-[13em] hover:border-black hover:bg-white hover:text-black"
            >
